...
kubectl delete pvc -l app=elasticsearch-master --ignore-not-found=true
...
kubectl apply -f daemonset.yml,elasticsearch-config.yml,access-log-template.yml,svc-elasticsearch-discovery.yml,elasticsearch-master.yml