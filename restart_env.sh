...
kubectl apply -f webconfig.yml,access-log-template.yml,fluentd_config.yml,fluentd_tomcat_config.yml,kibana-config.yml,tomcat_server_config.yml,tomcat_web_config.yml
