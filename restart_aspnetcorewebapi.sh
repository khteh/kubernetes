...
microk8s kubectl delete secret aspnetcorewebapi email-credentials --ignore-not-found=true
...
microk8s kubectl apply -f aspnetcorewebapi.postgresql.yml,appsettings.Production.yml,email-credentials.yml,svc-aspnetcorewebapi.yml,aspnetcorewebapi.yml
