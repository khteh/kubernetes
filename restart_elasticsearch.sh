...
kubectl delete configmap elasticsearch-config elasticsearch-resources access-log-template --ignore-not-found=true
...
kubectl apply -f daemonset.yml,elasticsearch-config.yml,elasticsearch-resources.yml,access-log-template.yml,svc-elasticsearch.yml,svc-elasticsearch-discovery.yml,elasticsearch-master.yml,elasticsearch.yml
