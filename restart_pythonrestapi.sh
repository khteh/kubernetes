...
kubectl apply -f access_log_template.yml,hypercorn_config.yml,pythonrestapi_config.yml,pythonrestapi-fluentd_config.yml,svc-pythonrestapi.yml,pythonrestapi.yml
