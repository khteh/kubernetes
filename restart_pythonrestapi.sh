...
kubectl apply -f access-log-template.yml,hypercorn_config.yml,pythonrestapi_config.yml,pythonrestapi-fluentd_config.yml,svc-pythonrestapi.yml,pythonrestapi.yml
